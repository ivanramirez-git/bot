...
public interface BotListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterFunction_declaration(BotParser.Function_declarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link BotParser#function_declaration}.
	 * @param ctx the parse tree
	 */
	void exitFunction_declaration(BotParser.Function_declarationContext ctx);
	/**
	 * Enter a parse tree produced by {@link BotParser#function_call}.
	 * @param ctx the parse tree
	 */
	void enterFunction_call(BotParser.Function_callContext ctx);
	/**
	 * Exit a parse tree produced by {@link BotParser#function_call}.
	 * @param ctx the parse tree
	 */
	void exitFunction_call(BotParser.Function_callContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link BotParser#input}.
	 * @param ctx the parse tree
	 */
	void enterInput(BotParser.InputContext ctx);
	/**
	 * Exit a parse tree produced by {@link BotParser#input}.
	 * @param ctx the parse tree
	 */
	void exitInput(BotParser.InputContext ctx);
	/**
